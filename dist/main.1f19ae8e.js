...
var app = Vue.createApp({
  ...
  computed: {
    computerProgressStyle: function computerProgressStyle() {
      if (this.computerHealth < 0) {
        ...
        return {
          width: this.computerHealth + "%"
        };
      }
    },
    playerProgressStyle: function playerProgressStyle() {
    ...
    checkSpecial: function checkSpecial() {
      return this.gameRound % 3 !== 0;
    },
    checkHeal: function checkHeal() {
  ...
  watch: {
    ...
    computerHealth: function computerHealth(value) {
  ...
  methods: {
    ...
    playerAttack: function playerAttack() {
      var value = getRandomAttackValue(5, 14);
    ...
    heal: function heal() {
      this.gameRound++;
      var value = getRandomAttackValue(8, 18);
      this.playerHealth += value;
    ...
    addBattleLog: function addBattleLog(player, condition, value) {
